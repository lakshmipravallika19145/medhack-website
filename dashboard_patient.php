...
$sql = "SELECT name, email, mobile FROM registered_patients WHERE id = ?";
...
<head>
    ...
    <title>MedHac | Patient Dashboard</title>
    <style>
        body {
            margin: 0;
...
<nav class="navbar">
    ...
    <div class="container">
        ...
        <div class="welcome-message">Welcome, <?php echo htmlspecialchars($patient['name']); ?>!</div>
        <div class="dashboard-content">
            <div class="card">
                <h3>Profile Information</h3>
                <p><strong>Name:</strong> <?php echo htmlspecialchars($patient['name']); ?></p>
                <p><strong>Email:</strong> <?php echo htmlspecialchars($patient['email']); ?></p>
                <p><strong>Mobile:</strong> <?php echo htmlspecialchars($patient['mobile']); ?></p>
            </div>
            <div class="card">
                <h3>Appointments</h3>
                <p>No upcoming appointments.</p>
                <p><a href="book_appointment.php" style="color: #007c91; text-decoration: none;">Book an Appointment</a></p>
            </div>
            <div class="card">
                <h3>Medical Records</h3>
                <p>View your medical history and prescriptions.</p>
                <p><a href="medical_records.php" style="color: #007c91; text-decoration: none;">View Records</a></p>
            </div>
        </div>
